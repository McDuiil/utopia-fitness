...
const WeightChartWidget = () => {
  console.log("render WeightChartWidget");
  ...
  const chartData = useMemo(() => {
    if (!days) return [{ date: 'N/A', weight: profileWeight || 0, bodyFat: profileBodyFat || 0 }];
    
    let rawData = Object.entries(days)
    ...
    if (rawData.length === 0) {
      return [{ date: 'N/A', weight: profileWeight, bodyFat: profileBodyFat }];
    }
  ...
  }, [days, profileWeight, profileBodyFat, range]);
...
export default memo(WeightChartWidget);
