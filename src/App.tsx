...
return (
// [MODIFIED] 移除 bg-[#050505] 和 overflow-hidden，避免覆盖背景和裁剪问题 <div className="min-h-screen w-full relative no-scrollbar flex flex-col">

```
  {/* Background Decorative Elements */}
  {/* [MODIFIED] 修复 z-index，避免 z-[-1] 带来的层级问题 */}
  <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
    {/* [MODIFIED] 降低 blur 强度，优化移动端性能 */}
  ...
  {/* Content Layer */}
  {/* [MODIFIED] 提升 z-index，确保内容始终在背景之上 */}
